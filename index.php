...
add_action( 'init', function(){
	...
	add_filter( 'kirki_control_types', function ( $controls ) {
		$controls['advanced-repeater'] = 'KIRKI_ADVANCED_REPEATER';
		return $controls;
	});
...
function kar_customize_register(){

	class KIRKI_ADVANCED_REPEATER extends Kirki_Control_Base {

		public $type = 'kirki-advanced-repeater';

		public function enqueue() {
			wp_enqueue_script( 
				'kirki-advanced-repeater-js', 
				plugin_dir_url( __FILE__ ) . 'js/scripts.js', 
				array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-datepicker' )
			);
			wp_enqueue_style( 
				'kirki-advanced-repeater-css', 
		...
		public function render_content() {
			...
			$default      = !empty( $this->value() ) ? json_decode( $this->value() , true ) : array();
			...
			<div class="kar_wrapper" data-limit="<?php echo absint( $limit ); ?>">
				...
				for ( $i=0; $i < count( $default ); $i++ ) { 
					kar_get_repeater_section( $row_label , $i , $fields , $default );					
				} 
				echo ob_get_clean();
				printf(
...
function kar_get_repeater_section( $row_label, $i, $fields, $default, $extra_class = '', $show_default_value_on_add_new_repeater = false ){ ?>
		...
		<div class="kar_fields_wrapper" style="display:none;">
			...
			foreach ( $fields as $key => $field ) {
				...
				switch ( $type ) {
					...
					case 'heading':
						kar_get_heading_field( $field , $key );
						break;

					case 'number':
						kar_get_number_field( $field , $default_value , $key , $show_default_value_on_add_new_repeater );
						break;

					case 'text':
						kar_get_text_field( $field , $default_value , $key , $show_default_value_on_add_new_repeater );
						break;

					case 'textarea':
						kar_get_textarea_field( $field , $default_value , $key , $show_default_value_on_add_new_repeater );
						break;

					case 'select':
						kar_get_select_field( $field , $default_value , $key , $extra_class, $show_default_value_on_add_new_repeater );
						break;

					case 'fontawesome':
						kar_get_icon_field( $field , $default_value , $key , $extra_class, $show_default_value_on_add_new_repeater );
						break;

					case 'color':
						kar_get_color_field( $field , $default_value , $key , $extra_class, $show_default_value_on_add_new_repeater );
						break;

					case 'image':
						kar_get_image_field( $field , $default_value , $key , $show_default_value_on_add_new_repeater );
						break;

					case 'radio':
						kar_get_radio_field( $field , $default_value , $key , $show_default_value_on_add_new_repeater );
						break;

					case 'checkbox':
						kar_get_checkbox_field( $field , $default_value , $key , $show_default_value_on_add_new_repeater );
						break;
...
function kar_get_heading_field( $field, $key ){
...
function kar_get_checkbox_field( $field, $default_value, $key, $show_default_value_on_add_new_repeater ){
...
function kar_get_radio_field( $field, $default_value, $key, $show_default_value_on_add_new_repeater ){
...
function kar_get_image_field( $field, $default_value, $key, $show_default_value_on_add_new_repeater ){
...
function kar_get_color_field( $field, $default_value, $key, $extra_class, $show_default_value_on_add_new_repeater ){
...
function kar_get_select_options( $data, $default_value ){
...
function kar_get_icon_options( $data, $default_value ){
...
function kar_get_icon_field( $field, $default_value, $key, $extra_class, $show_default_value_on_add_new_repeater ){
	...
	<?php echo esc_attr( $active_callback ); ?>>
		...
		class="kar_fontawesome <?php echo esc_attr( $extra_class ); ?>">
			<?php 
			$choices = !empty( $field['choices'] ) ? $field['choices'] : array();
			kar_get_icon_options( $choices, $default_value );
			?>
		</select>
	</div>
	<?php
...
function kar_get_select_field( $field, $default_value, $key, $extra_class, $show_default_value_on_add_new_repeater ){
	...
	<?php echo esc_attr( $active_callback ); ?>>
		...
		<?php echo (!empty( $field['multiple'] ) ? 'multiple' : '') ?>>
			<?php 
			$choices = !empty( $field['choices'] ) ? $field['choices'] : array();
			kar_get_select_options( $choices, $default_value );
			?>
		</select>
	</div>
...
function kar_get_textarea_field( $field, $default_value, $key, $show_default_value_on_add_new_repeater ){
...
function kar_get_text_field( $field, $default_value, $key, $show_default_value_on_add_new_repeater ){
...
function kar_get_number_field( $field, $default_value, $key, $show_default_value_on_add_new_repeater ){
...
function kar_get_date_field( $field, $default_value, $key, $extra_class, $show_default_value_on_add_new_repeater ){
